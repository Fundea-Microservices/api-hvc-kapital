...
export class CreateAccesoDto {
  ...
  @IsGuid({ message: 'Campo menuId debe ser un UUID válido.' })
  menuId!: string;
  ...
  @IsGuid({ message: 'Campo rolId debe ser un UUID válido.' })
  rolId!: string;
  ...
  @IsGuid({ message: 'Campo mainMenuId debe ser un UUID válido.' })
  @IsOptional()
  mainMenuId?: string;
}
